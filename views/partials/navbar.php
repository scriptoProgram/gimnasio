...
function renderNavbar($role) { ?>
    ...
    <div class="fixed bg-black left-0 w-[16rem] h-full p-[12px]" id="navbar">
        ...
        <nav>
            <div class="static flex flex-col">
                <ul class="grid grid-cols-1 gap-1">
                    <li>
                        <a class='text-white font-semibold grid auto-cols-[minmax(0,1fr)_minmax(0,4fr)] grid-flow-col gap-1' href='main.php'>
        ...
        <nav>
            <ul>
                <li>
                    <a class='text-white font-semibold grid auto-cols-[minmax(0,1fr)_minmax(0,4fr)] grid-flow-col gap-1'
        ...
        <div class="grid justify-items-center" id="content-user">
            ...
            <p class="capitalize text-white text-center font-semibold m-[0.3rem]"><?php echo strtolower($_SESSION['name']); ?></p>
        </div>
    </div>
<?php } ?>